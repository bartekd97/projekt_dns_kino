...
public class WaterSquare : MonoBehaviour
{
    ...
    public void Start()
    {
        this.squareTransform = transform;
        this.squareTransform = transform;
        ...
        this.centerPos = squareTransform.localPosition;
    ...
    public void GenerateMesh()
    {
        ...
        terrainMeshFilter.mesh.uv = uvs.ToArray();
        terrainMeshFilter.mesh.name = "Water Mesh";
        this.GetComponent<Renderer>().material.SetTexture("Water",material.mainTexture);
